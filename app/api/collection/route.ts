/**
 * Server-side API route for token collection data
 *
 * Handles cache-first token collection fetching with Redis caching,
 * filtering, and pagination. All Redis operations are server-side only.
 */
...
export async function GET(request: NextRequest) {
    try {
        ...
        // Use data orchestrator for cache-first collection fetching
